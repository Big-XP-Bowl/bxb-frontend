...
import { Card1, EmpImage, EmpTitle, EmpDetails, EmpInitials } from '../styles/Cards';
    ...
    <Grid1>
      {employees.map((employee) => (
        <Card1 key={employee.id} onClick={() => setSelectedEmployee(employee)}>
          <EmpImage src={employee.image_url} alt={employee.name} onError={(error) => console.error('Image failed to load:', error)} />
